...
import (
	...
	"awesomeProject/shengxian/mxshop_srv/goods_srv/handler"
	"awesomeProject/shengxian/mxshop_srv/goods_srv/initialize"
	goodspb "awesomeProject/shengxian/mxshop_srv/goods_srv/proto/goods"
	"awesomeProject/shengxian/mxshop_srv/goods_srv/utils"
	"flag"
	"fmt"
...
func main() {
	...
	goodspb.RegisterGoodsServer(server,&handler.GoodsService{})
	...
	registration.Tags = []string{"mxshop","nmsl","goods"}
